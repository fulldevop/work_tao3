...
class ConstructorFields extends Base
{
	use Actions;
	...
	protected function listAction()
	{
		...
		return $this->render('constructor_fields ~ index');
	}
	...
	protected function editAction()
	{
		...
		return $this->render('constructor_fields ~ edit', array(
			'id' => $this->id,
			'item' => $item,
	...
	public function beforeAction($method, $parameters)
	{
		...
		$this->title = isset($cfg['title']) ? $cfg['title'] : 'Конструктор полей';
	}
